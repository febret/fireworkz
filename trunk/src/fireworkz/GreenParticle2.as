package fireworkz 
{
	 ...
	 */
	public class GreenParticle2 extends Sprite
	{
		/******************************************************************************************
		 * Other constants.
		 */
		...
		/******************************************************************************************
		 */
		public function GreenParticle2(game: Game, x: Number, y: Number, vx: Number, vy: Number) 
		{
			myGame = game;
		...
		private function onFrame(e: Event): void 
		{
			...
			if (myPoints.length >= TRAIL_LENGTH)
			{
				...
				for (var i: int = 1; i < TRAIL_LENGTH - 2; i++)
				{
					graphics.lineStyle(i / 8, 0xffffff, 0.4);
