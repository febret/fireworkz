package fireworkz 
{
	 ...
	 */
	public class RedParticle2 extends Sprite
	{
		/******************************************************************************************
		 * Other constants.
		 */
		...
		/******************************************************************************************
		 */
		public function RedParticle2(game: Game, x: Number, y: Number, vx: Number, vy: Number) 
		{
			myGame = game;
		...
		private function onFrame(e: Event): void 
		{
			...
			if (myPoints.length >= TRAIL_LENGTH)
			{
				...
				{
					graphics.lineStyle((TRAIL_LENGTH - i) / 5, 0xffffff, 1);
