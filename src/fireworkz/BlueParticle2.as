package fireworkz 
{
	 ...
	 */
	public class BlueParticle2 extends Sprite
	{
		/******************************************************************************************
		 * Other constants.
		 */
		public static const TRAIL_LENGTH: int = 16;
		public static const MOVE_LENGTH: int = 10;
		public static const FADE_LENGTH: int = 5;
		public static const FRICTION: int = 2;

		/******************************************************************************************
		 */
		public function BlueParticle2(game: Game, x: Number, y: Number, vx: Number, vy: Number) 
		{
			myGame = game;
		...
		private function onFrame(e: Event): void 
		{
			...
			if (myPoints.length >= TRAIL_LENGTH)
			{
				...
				{
					graphics.lineStyle(i / 12, 0xffffff, 1);
