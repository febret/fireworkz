package fireworkz 
{
	 ...
	 */
	public class WhiteParticle1 extends Sprite
	{
		/******************************************************************************************
		 * Other constants.
		 */
		public static const TRAIL_LENGTH: int = 8;
		...
		/******************************************************************************************
		 */
		public function WhiteParticle1(game: Game, x: Number, y: Number, vx: Number, vy: Number) 
		{
			myGame = game;
		...
		private function onFrame(e: Event): void 
		{
			...
			if (myPoints.length >= TRAIL_LENGTH)
			{
				...
				{
					graphics.lineStyle(i / 16, 0xffffff, 1);
